import { ChatermIgnoreController } from './ChatermIgnoreController'
...
describe('ChatermIgnoreController', () => {
  let tempDir: string
  let controller: ChatermIgnoreController
  ...
  describe('Error Handling', () => {
    ...
    it('should handle missing .clineignore gracefully', async () => {
      ...
      try {
        const controller = new ChatermIgnoreController(emptyDir)
        await controller.initialize()
