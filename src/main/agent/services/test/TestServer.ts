 ...
 */
async function updateAutoApprovalSettings(
        ...
        try {
          ...
          try {
            ...
            const toolMetrics = {
              ...
              toolSuccessRate: calculateToolSuccessRate(
                toolTracker.toolCalls,
                toolTracker.toolFailures
              )
            }
