...
const getClineRulesFilesTotalContent = async (
...
export async function refreshClineRulesToggles(
  ...
  const globalClineRulesToggles =
    ((await getGlobalState(context, 'globalClineRulesToggles')) as ClineRulesToggles) || {}
  ...
  const localClineRulesToggles =
    ((await getWorkspaceState(context, 'localClineRulesToggles')) as ClineRulesToggles) || {}
