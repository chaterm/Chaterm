...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
  const [
    ...
    getGlobalState(context, 'vsCodeLmModelSelector') as Promise<
    ...
    getGlobalState(context, 'previousModeVsCodeLmModelSelector') as Promise<
      vscode.LanguageModelChatSelector | undefined
    >,
    ...
    getGlobalState(context, 'previousModeAwsBedrockCustomModelBaseId') as Promise<
