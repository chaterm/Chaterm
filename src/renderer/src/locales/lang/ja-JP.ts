...
export default {
  common: {
    ...
    files: 'ファイル',
    management: '資産管理',
    keyManagement: '認証情報管理',
    keyManagementDesc: 'SSH パスワード、キー、証明書を管理',
  ...
  user: {
    ...
    check: '確認',
    modelLimits: 'モデルの上限',
    modelLimitsHint: 'モデルの横にある設定アイコンから、コンテキストウィンドウと最大出力トークンを設定できます。',
    contextWindow: 'コンテキストウィンドウ（トークン）',
    contextWindowPh: '例: 1000000',
    maxOutputTokens: '最大出力トークン',
    maxOutputTokensPh: '例: 32768',
    ...
    accountCenterDescription: 'アカウントと請求を管理',
    goToAccountCenter: 'アカウントセンターへ',
  ...
  extensions: {
    ...
    import: 'インポート',
    importSkip: '既存をスキップ',
    importOverwrite: '既存を上書き',
    importEmpty: 'インポートするエイリアスがありません',
    importParseError: 'JSON 形式が無効です。{ alias, command } の配列が必要です。',
    importSummary: '{added} 件インポート、{skipped} 件スキップ、{failed} 件失敗',
    exportCommand: 'エクスポート',
    exportEmpty: 'エクスポートするエイリアスがありません',
    noDescription: '説明なし',
    ...
    uninstallDirectoryBusy:
      'プラグインディレクトリが使用中です。アンインストールできません。しばらく待ったり、Chatermを再起動してからお試しください。',
    install: 'インストール',
    subscribe: '購読',
    update: '更新',
  ...
  personal: {
    ...
    passwordCredential: 'パスワード認証情報',
    pleaseSelectPasswordCredential: 'パスワード認証情報を選択してください',
    passwordCredentialLoadFailed: 'パスワード認証情報の読み込みに失敗しました',
    validationPasswordCredentialRequired: 'パスワード認証情報は必須です',
    validationPasswordCredentialUsernameRequired: 'パスワード認証情報にユーザー名がありません。認証情報管理で更新してください。',
    pleaseInputAlias: '例: 本番DB',
    pleaseSelectGroup: 'グループを選択または新規作成',
    newGroup: '新規グループ',
    newGroupPlaceholder: 'グループ名を入力して Enter キーを押す',
    pleaseSelectSshProxy: 'SSHプロキシを選択してください',
    proxyConfig: 'SSHプロキシ',
    advancedOptions: '詳細オプション',
    jumpHost: '踏み台サーバー',
    jumpHostSelect: '踏み台サーバーを選択',
    ...
    batchDeleteHostsConfirm: '選択した {count} 件のホスト設定を削除しますか？この操作は元に戻せません。',
    batchDeleteHostsSuccess: '{count} 件のホスト設定を削除しました',
    batchDeleteHostsBastionWarning: '選択した踏み台ホストに関連する資産設定も削除されます。',
    selectAllMatchingHosts: '検索結果をすべて選択',
    ...
    importFormatAuthType: '認証方式 (オプション, "password"、"passwordCredential"、または"keyBased")',
    ...
    removeFromRecentConnections: '最近の接続から削除',
    assetMoved: '資産が正常に移動されました',
    assetRemoved: '資産が正常に削除されました',
    assetMoveFailed: '資産の移動に失敗しました',
    assetRemoveFailed: '資産の削除に失敗しました',
    recentConnectionRemoved: '最近の接続を削除しました',
    recentConnectionRemoveFailed: '最近の接続の削除に失敗しました',
  ...
  ai: {
    ...
    retry: '再試行',
    taskCompleted: 'タスク完了',
    kbSearchProgressRunning: 'ナレッジベースを検索中 · {seconds}秒',
    kbSearchProgressCompleted: 'ナレッジベースの検索が完了しました · {seconds}秒',
    kbSearchProgressFailed: 'ナレッジベースの検索に失敗しました · {seconds}秒',
    kbSearchProgressEmbedding: 'クエリベクトルを生成',
    kbSearchProgressRetrieving: 'ベクトル検索とキーワード検索を実行',
    kbSearchProgressReranking: '候補の関連性を分析',
    kbSearchProgressRerankFallback: '再ランキングに失敗したため、検索順を使用',
    kbSearchProgressPreparing: '取得したコンテキストを回答用に整理',
    kbSearchProgressFailedStep: 'ナレッジベースのコンテキストなしで続行',
    kbSearchProgressResults: '検索完了：{count}件の結果',
    kbSearchProgressDuration: '{seconds}秒',
    kbSearchProgressCandidates: '{count}件の候補を分析',
    taskProgress: 'タスク進捗',
  ...
  keyChain: {
    ...
    credentialType: '管理タイプ',
    passwordCredential: 'パスワード管理',
    keyCredential: 'キー管理',
    editKey: 'キーを編集',
    saveKey: 'キーを保存',
    ...
    createKey: 'キーを作成',
    deleteConfirm: '削除確認',
    deleteConfirmContent: '認証情報 "{name}" を削除してもよろしいですか？',
    privateKey: '秘密鍵',
    publicKey: '公開鍵',
    passphrase: 'パスフレーズ',
    username: 'ユーザー名',
    ...
    name: '名前',
    type: 'タイプ: ',
    deleteSuccess: '認証情報 {name} を削除しました',
    deleteFailure: '削除に失敗しました',
    deleteError: '削除エラー: {error}',
    createSuccess: 'キーが正常に作成されました',
    createCredentialSuccess: '認証情報を作成しました',
    saveSuccess: '保存成功',
    saveError: '保存エラー',
  ...
  files: {
    ...
    copyAbsolutePathSuccess: '絶対パスをコピーしました',
    copyAbsolutePathFailed: '絶対パスのコピーに失敗しました',
    more: '更多',
    download: 'ダウンロード',
