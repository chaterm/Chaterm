...
export default {
  common: {
    ...
    files: '파일',
    management: '자산 관리',
    keyManagement: '자격 증명 관리',
    keyManagementDesc: 'SSH 비밀번호, 키 및 인증서 관리',
  ...
  user: {
    ...
    themeLight: '라이트',
    themeAuto: '자동',
    themeGroupSystem: '시스템',
    themeGroupDefault: '기본',
    themeGroupOfficial: '공식 테마',
    ...
    check: '확인',
    modelLimits: '모델 제한',
    modelLimitsHint: '모델 옆의 설정 아이콘에서 컨텍스트 창과 최대 출력 토큰을 설정할 수 있습니다.',
    contextWindow: '컨텍스트 창(토큰)',
    contextWindowPh: '예: 1000000',
    maxOutputTokens: '최대 출력 토큰',
    maxOutputTokensPh: '예: 32768',
    ...
    accountCenterDescription: '계정 및 결제를 관리하세요',
    goToAccountCenter: '계정 센터로 이동',
  ...
  extensions: {
    ...
    import: '가져오기',
    importSkip: '기존 항목 건너뛰기',
    importOverwrite: '기존 항목 덮어쓰기',
    importEmpty: '가져올 별칭이 없습니다',
    importParseError: 'JSON 형식이 잘못되었습니다. { alias, command } 배열이어야 합니다.',
    importSummary: '{added}개 가져옴, {skipped}개 건너뜀, {failed}개 실패',
    exportCommand: '내보내기',
    exportEmpty: '내보낼 별칭이 없습니다',
    noDescription: '설명 없음',
    installFailed: '설치 실패',
    ...
    uninstallDirectoryBusy: '플러그인 디렉터리가 사용 중이어서 제거할 수 없습니다. 잠시 후 다시 시도하거나 Chaterm을 재시작한 후에 시도해 주세요.',
    install: '설치',
    subscribe: '구독',
    update: '업데이트',
  ...
  personal: {
    ...
    passwordCredential: '비밀번호 자격 증명',
    pleaseSelectPasswordCredential: '비밀번호 자격 증명을 선택해주세요',
    passwordCredentialLoadFailed: '비밀번호 자격 증명을 불러오지 못했습니다',
    validationPasswordCredentialRequired: '비밀번호 자격 증명은 비워둘 수 없습니다',
    validationPasswordCredentialUsernameRequired: '비밀번호 자격 증명에 사용자 이름이 없습니다. 자격 증명 관리에서 업데이트해주세요.',
    pleaseInputAlias: '예: 프로덕션 DB',
    pleaseSelectGroup: '그룹 선택 또는 새로 만들기',
    newGroup: '새 그룹',
    newGroupPlaceholder: '그룹 이름을 입력하고 Enter 키를 누르세요',
    pleaseSelectSshProxy: 'SSH 프록시를 선택해주세요',
    proxyConfig: 'SSH 프록시',
    advancedOptions: '고급 옵션',
    jumpHost: '점프 호스트',
    jumpHostSelect: '점프 호스트 선택',
    ...
    batchDeleteHostsConfirm: '선택한 호스트 설정 {count}개를 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
    batchDeleteHostsSuccess: '호스트 설정 {count}개를 삭제했습니다',
    batchDeleteHostsBastionWarning: '선택한 배스천 호스트에 연결된 자산 설정도 삭제됩니다.',
    selectAllMatchingHosts: '검색 결과 모두 선택',
    ...
    selectExportHostsTitle: '내보낼 호스트 선택',
    selectExportHostsDescription: '개별 호스트 또는 그룹 전체를 선택하세요. 그룹을 선택하면 해당 그룹의 모든 호스트가 포함됩니다.',
    selectExportHostsEmpty: '내보낼 수 있는 호스트가 없습니다',
    searchHosts: '호스트 검색',
    selectAll: '전체 선택',
    clearSelection: '지우기',
    selectedCount: '{count}개 호스트 선택됨',
    ...
    importFormatAuthType: '인증 타입 (선택, "password", "passwordCredential" 또는 "keyBased")',
    ...
    removeFromRecentConnections: '최근 연결에서 제거',
    assetMoved: '자산 이동 성공',
    assetRemoved: '자산 제거 성공',
    assetMoveFailed: '자산 이동 실패',
    assetRemoveFailed: '자산 제거 실패',
    recentConnectionRemoved: '최근 연결을 제거했습니다',
    recentConnectionRemoveFailed: '최근 연결 제거 실패',
    selectFolder: '폴더 선택',
    noFolders: '커스텀 폴더 없음',
  ...
  ai: {
    ...
    retry: '다시 시도',
    taskCompleted: '작업 완료',
    kbSearchProgressRunning: '지식 베이스 검색 중 · {seconds}초',
    kbSearchProgressCompleted: '지식 베이스 검색 완료 · {seconds}초',
    kbSearchProgressFailed: '지식 베이스 검색 실패 · {seconds}초',
    kbSearchProgressEmbedding: '쿼리 벡터 생성',
    kbSearchProgressRetrieving: '벡터 및 키워드 검색 실행',
    kbSearchProgressReranking: '후보 결과의 관련성 분석',
    kbSearchProgressRerankFallback: '재정렬에 실패하여 검색 순서를 사용합니다',
    kbSearchProgressPreparing: '검색된 컨텍스트를 답변에 맞게 정리',
    kbSearchProgressFailedStep: '지식 베이스 컨텍스트 없이 계속 진행',
    kbSearchProgressResults: '검색 완료: 결과 {count}개',
    kbSearchProgressDuration: '{seconds}초',
    kbSearchProgressCandidates: '후보 {count}개 분석',
    taskProgress: '작업 진행률',
    focusChain: '포커스 체인',
    currentFocus: '현재 포커스',
  ...
  keyChain: {
    ...
    deleteConfirmContent: '자격 증명 "{name}"을 삭제하시겠습니까?',
    privateKey: '비밀키',
    publicKey: '공개키',
    passphrase: '비밀번호',
    username: '사용자 이름',
    ...
    name: '이름',
    type: '형식: ',
    deleteSuccess: '자격 증명 {name} 삭제 성공',
    deleteFailure: '삭제 실패',
    deleteError: '삭제 오류: {error}',
    createSuccess: '키 생성 성공',
    createCredentialSuccess: '자격 증명 생성 성공',
    saveSuccess: '저장 성공',
    saveError: '저장 오류',
  ...
  files: {
    ...
    copyAbsolutePathSuccess: '절대 경로가 복사되었습니다',
    copyAbsolutePathFailed: '절대 경로 복사 실패',
    more: '더 보기',
    download: '다운로드',
  ...
  database: {
    ...
    editPasswordPlaceholder: '비워 두면 기존 비밀번호가 유지됩니다',
    addRow: '행 추가',
    deleteRow: '행 삭제',
    undo: '실행 취소',
    ...
    dbAi: {
      title: '데이터베이스 AI',
      drawerTitle: '데이터베이스 AI 결과',
      emptyState: '아직 DB-AI 요청이 없습니다. SQL 편집기에서 설명, 자연어 → SQL, 최적화 또는 변환을 실행하세요.',
      emptyInput: 'AI에 보낼 내용이 없습니다.',
      contextRequired: '먼저 연결과 데이터베이스를 선택하세요.',
      unknownError: 'DB-AI 요청에 실패했습니다.',
      reasoning: '추론',
      generatedSql: '생성된 SQL',
      targetDialect: '대상 방언',
      textOnlyDialectHint: '텍스트 전용 변환이며, 읽기 전용 실행은 비활성화되어 있습니다.',
      insertIntoEditor: '편집기에 삽입',
      replaceSelection: '선택 영역 바꾸기',
      insertedIntoEditor: '편집기에 삽입되었습니다',
      replacedSelection: '선택 영역이 바뀌었습니다',
      copy: 'SQL 복사',
      copyFailed: '복사 실패',
      runReadOnly: '실행 (읽기 전용)',
      cancel: '요청 취소',
      clear: '지우기',
      statusIdle: '대기',
      statusQueued: '대기열',
      ...
      statusCancelled: '취소됨',
      diagnosing: 'AI 분석 중...',
      diagnosedAndReplaced: 'SQL이 수정되어 교체되었습니다',
      actionExplain: '설명',
      actionNl2Sql: '자연어 → SQL',
      actionOptimize: '최적화',
      actionConvert: '방언 변환',
      actionComplete: '자동 완성',
      actionDiagnose: 'AI 수정',
      nl2SqlPrompt: {
        title: '질문으로 SQL 생성',
        hint: '자연어로 조회하려는 내용을 설명하세요. 현재 연결과 스키마가 컨텍스트로 사용됩니다.',
        placeholder: '예: 지난 30일 동안 총 결제 금액이 가장 높은 상위 5명의 고객 표시',
        submit: '생성',
        cancel: '취소'
      }
    }
