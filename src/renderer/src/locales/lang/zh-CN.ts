...
export default {
  common: {
    ...
    management: '资产管理',
    keyManagement: '凭据管理',
    keyManagementDesc: '管理 SSH 密码、密钥和证书',
    hostManagement: '主机管理',
  ...
  user: {
    ...
    kbRerankModeOff: '关闭',
    kbRerankModel: '重排模型',
    kbRerankModelPlaceholder: '选择一个已启用模型',
    kbRerankModelTypeRerank: 'rerank',
    kbRerankSaveFailed: '重排设置保存失败',
    ...
    accountCenterDescription: '管理你的账号和订阅',
    goToAccountCenter: '前往账号中心',
  ...
  extensions: {
    ...
    importEmpty: '没有可导入的别名',
    importParseError: 'JSON 格式无效，应为 { alias, command } 数组。',
    importSummary: '导入 {added} 条，跳过 {skipped} 条，失败 {failed} 条',
    exportCommand: '导出',
    exportEmpty: '没有可导出的别名',
    noDescription: '暂无描述',
    installFailed: '安装失败',
  ...
  personal: {
    ...
    pleaseSelectPasswordCredential: '请选择密码凭据',
    passwordCredentialLoadFailed: '读取密码凭据失败',
    validationPasswordCredentialRequired: '密码凭据不能为空',
    validationPasswordCredentialUsernameRequired: '密码凭据缺少用户名，请前往凭据管理补充',
    ...
    batchDeleteHostsConfirm: '确定删除选中的 {count} 个主机配置？此操作无法撤销。',
    batchDeleteHostsSuccess: '已删除 {count} 个主机配置',
    batchDeleteHostsBastionWarning: '所选堡垒机的关联资产配置也会被删除。',
    selectAllMatchingHosts: '全选搜索结果',
    ...
    importFormatAuthType: '认证方式（可选，"password"、"passwordCredential"或"keyBased"）',
    ...
    removeFromRecentConnections: '从最近连接移除',
    assetMoved: '资产移动成功',
    assetRemoved: '资产移除成功',
    assetMoveFailed: '资产移动失败',
    assetRemoveFailed: '资产移除失败',
    recentConnectionRemoved: '最近连接已移除',
    recentConnectionRemoveFailed: '移除最近连接失败',
    selectFolder: '选择分组',
    noFolders: '暂无自定义分组',
  ...
  ai: {
    ...
    retry: '重试',
    taskCompleted: '任务已完成',
    kbSearchProgressRunning: '正在检索知识库 · {seconds}秒',
    kbSearchProgressCompleted: '已完成知识库检索 · {seconds}秒',
    kbSearchProgressFailed: '知识库检索失败 · {seconds}秒',
    kbSearchProgressEmbedding: '生成查询向量',
    kbSearchProgressRetrieving: '执行向量与关键词混合检索',
    kbSearchProgressReranking: '分析候选内容的相关性',
    kbSearchProgressRerankFallback: '重排失败，已使用检索排序',
    kbSearchProgressPreparing: '整理检索结果，准备生成回答',
    kbSearchProgressFailedStep: '跳过知识库内容，继续处理请求',
    kbSearchProgressResults: '检索完成，找到 {count} 条结果',
    kbSearchProgressDuration: '耗时 {seconds}秒',
    kbSearchProgressCandidates: '分析 {count} 条候选内容',
    taskProgress: '运维任务进度',
    focusChain: '聚焦链',
    currentFocus: '当前聚焦',
    contextUsage: '上下文使用',
  ...
  keyChain: {
    ...
    createKey: '创建密钥',
    deleteConfirm: '删除确认',
    deleteConfirmContent: '确定要删除凭据 "{name}" 吗？',
    privateKey: '私钥',
    publicKey: '公钥',
    passphrase: '私钥的密码',
    username: '用户名',
    ...
    name: '名称',
    type: '类型：',
    deleteSuccess: '删除凭据 {name} 成功',
    deleteFailure: '删除失败',
    deleteError: '删除出错: {error}',
    createSuccess: '创建密钥成功',
    createCredentialSuccess: '创建凭据成功',
    saveSuccess: '保存成功',
    saveError: '保存出错',
