export default {
  ...
  skills: {
    title: 'Skills',
    description:
      'Skills 是基于开放的 Agent Skills 标准构建的可重用指令集，可以把指令、脚本和资源打包到独立的"文件夹"（SKILL.md）里，从而封装定制专业能力给 Agent。',
    openFolder: '打开文件夹',
    reload: '重新加载',
    create: '创建技能',
    ...
    skillVersion: '版本',
    skillAuthor: '作者',
    skillAuthorPlaceholder: '您的名字或组织',
    skillActivation: '激活方式',
    activationAlways: '始终激活',
    activationOnDemand: '按需激活',
    activationContextMatch: '上下文匹配',
    contextPatterns: '上下文匹配关键词',
    contextPatternsPlaceholder: '用逗号分隔，例如：log, error, debug',
    contextPatternsHint: '当用户消息包含这些关键词时，技能将被激活',
    contextPatternsRequired: '上下文匹配激活方式需要填写匹配关键词',
    skillTags: '标签',
    skillTagsPlaceholder: '用逗号分隔，例如：docker, deployment',
    skillContent: '技能内容',
