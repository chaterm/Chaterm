export default {
  ...
  skills: {
    title: 'Skills',
    description:
      'Skills are reusable instruction sets built on the open Agent Skills standard. Package instructions, scripts, and resources into standalone folders (SKILL.md) to encapsulate specialized capabilities for the Agent.',
    ...
    skillId: 'Skill ID',
    skillIdPlaceholder: 'e.g., docker-deploy',
    skillName: 'Skill Name',
    skillNamePlaceholder: 'e.g., Docker Deployment Helper',
    skillDescription: 'Description',
    skillDescriptionPlaceholder: 'Briefly describe what this skill does',
    skillVersion: 'Version',
    skillAuthor: 'Author',
    skillAuthorPlaceholder: 'Your name or organization',
    skillActivation: 'Activation',
    activationAlways: 'Always Active',
    activationOnDemand: 'On-Demand',
    activationContextMatch: 'Context Match',
    contextPatterns: 'Context Match Keywords',
    contextPatternsPlaceholder: 'Comma-separated, e.g., log, error, debug',
    contextPatternsHint: 'The skill will be activated when user message contains these keywords',
    contextPatternsRequired: 'Context match activation requires match keywords',
    skillTags: 'Tags',
    skillTagsPlaceholder: 'Comma-separated, e.g., docker, deployment',
    skillContent: 'Skill Content',
    skillContentPlaceholder: 'Write the skill instructions here (Markdown format)...',
    activation: 'Activation',
    sourceBuiltin: 'Built-in',
    sourceUser: 'User Created',
    sourceMarketplace: 'Marketplace',
    fillRequired: 'Please fill in all required fields',
    invalidId: 'ID can only contain lowercase letters, numbers, and hyphens',
