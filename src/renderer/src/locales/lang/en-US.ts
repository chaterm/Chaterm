...
export default {
  common: {
    ...
    keyManagement: 'Credential Management',
    keyManagementDesc: 'Manage SSH passwords, keys, and certificates',
  ...
  user: {
    ...
    modelLimitsHint: 'Use the settings icon next to a model to configure its context window and max output tokens.',
    contextWindow: 'Context window (tokens)',
    contextWindowPh: 'e.g. 1000000',
    maxOutputTokens: 'Max output tokens',
    maxOutputTokensPh: 'e.g. 32768',
    modelLimitsDescribe: 'Set the limits supported by this model. Leave blank to use the provider default.',
    ...
    accountCenterDescription: 'Manage your account and billing',
  ...
  extensions: {
    ...
    importEmpty: 'No alias to import',
    importParseError: 'Invalid JSON format. Expected an array of { alias, command }.',
    importSummary: 'Imported {added}, skipped {skipped}, failed {failed}',
    exportCommand: 'Export',
    exportEmpty: 'No alias to export',
  ...
  personal: {
    ...
    pleaseSelectPasswordCredential: 'Please select password credential',
    passwordCredentialLoadFailed: 'Failed to load password credential',
    validationPasswordCredentialRequired: 'Password credential cannot be empty',
    validationPasswordCredentialUsernameRequired: 'Password credential is missing a username. Please update it in credential management.',
    ...
    batchDeleteHostsConfirm: 'Delete the {count} selected host configurations? This action cannot be undone.',
    batchDeleteHostsSuccess: 'Deleted {count} host configuration(s)',
    batchDeleteHostsBastionWarning: 'Asset configurations associated with the selected bastion hosts will also be deleted.',
    selectAllMatchingHosts: 'Select All Search Results',
    ...
    importFormatAuthType: 'Auth type (optional, "password", "passwordCredential", or "keyBased")',
    ...
    removeFromRecentConnections: 'Remove from Recent Connections',
    ...
    recentConnectionRemoved: 'Recent connection removed',
    recentConnectionRemoveFailed: 'Failed to remove recent connection',
  ...
  ai: {
    ...
    kbSearchProgressRunning: 'Searching knowledge base · {seconds}s',
    kbSearchProgressCompleted: 'Knowledge base search completed · {seconds}s',
    kbSearchProgressFailed: 'Knowledge base search failed · {seconds}s',
    kbSearchProgressEmbedding: 'Generate the query embedding',
    kbSearchProgressRetrieving: 'Run vector and keyword retrieval',
    kbSearchProgressReranking: 'Analyze candidate relevance',
    kbSearchProgressRerankFallback: 'Reranking failed; using retrieval order',
    kbSearchProgressPreparing: 'Prepare the retrieved context for the answer',
    kbSearchProgressFailedStep: 'Continue without knowledge base context',
    kbSearchProgressResults: 'Search complete with {count} results',
    kbSearchProgressDuration: '{seconds}s',
    kbSearchProgressCandidates: 'Analyze {count} candidates',
  ...
  keyChain: {
    ...
    deleteConfirm: 'Delete Confirmation',
    deleteConfirmContent: 'Are you sure you want to delete credential "{name}"?',
    ...
    name: 'Name',
    type: 'Type: ',
    deleteSuccess: 'Credential {name} deleted successfully',
    deleteFailure: 'Delete failed',
    deleteError: 'Delete error: {error}',
    createSuccess: 'Key created successfully',
    createCredentialSuccess: 'Credential created successfully',
    saveSuccess: 'Save successful',
    saveError: 'Save error',
