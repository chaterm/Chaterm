export default {
  ...
  user: {
    ...
    noAvailableModelDescription: 'Please configure a model first, Setting -> Models -> Add Model -> API Configuration',
    noAvailableModelDescriptionLogin: 'Please login or configure a model first, Setting -> Models -> Add Model -> API Configuration',
