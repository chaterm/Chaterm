...
- Before executing commands, check the "Actively Running Terminals" section in environment_details. If present, consider how these active processes might impact your task. For example, if a remote server is already connected, you wouldn't need to connect with it again. If no active terminals are listed, please ask user to connect with target server first.
